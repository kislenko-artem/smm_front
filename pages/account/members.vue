...
export default {
  ...
  methods: {
    startSearch() {
      const self = this;
      fetch("http://46.229.212.40:9999/v0/vk/stat/groups/" + this.search, {
        method: "post",
        headers: {
        ...
        let interval = setInterval(() => {
          fetch('http://46.229.212.40:9999/v0/vk/stat/groups/' + this.search + "?age=1")
            .then((response) => {
        ...
        let intervalAge = setInterval(() => {
          fetch('http://46.229.212.40:9999/v0/vk/stat/groups/' + this.search + "?geography=1")
            .then((response) => {
                return response.json();
              }
            )
